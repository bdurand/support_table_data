...
RSpec.describe SupportTableData::Documentation do
  ...
  describe "#instance_helper_yard_doc" do
    it "generates YARD documentation for a named instance class method" do
      ...
      expect(result).to include("# Find the red record from the database.")
  ...
  describe "#class_def_with_yard_docs" do
    ...
    it "generates YARD docs for all named instances" do
      ...
      expect(result).to include("# Begin autogenerated YARD docs")
      expect(result).to include("# End autogenerated YARD docs")

      # Check for class definition
      expect(result).to include("class Color")

      # Check for named instances (Color has black, blue, green, red)
      expect(result).to include("# Find the black record from the database.")
      ...
      expect(result).to include("# Find the blue record from the database.")
    ...
    it "includes attribute helper methods when defined" do
      ...
      expect(result).to include("# Get the group_id value for the gray record.")
      expect(result).to include("def self.gray_group_id; end")
      expect(result).to include("# Get the name value for the gray record.")
      expect(result).to include("def self.gray_name; end")
    end
